      ...
      children: [
        Positioned(
          ...
          child:  Column(
              ...
              children: [
                Container(
                  width: ScreenUtil().setWidth(250), // adjust the width to your needs
                  height: ScreenUtil().setHeight(220), // adjust the height to your needs
                  child: Image.asset(
                 ...
                 Container(
                   width: 130.w,
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        primary: Color.fromRGBO(159, 156, 152, 1),
                      ...
                      child: Text(
                        "Pilih Gerakanmu",
                        style:
                            TextStyle(color: Color.fromRGBO(238, 232, 213, 1), fontSize: 13.sp),
                      ),
                    ),
                  ),
              ],
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                FittedBox(
                    fit: BoxFit.cover,
                    child: Image.asset("assets/images/article.png", width: 230, height: 220,)),
                Transform.translate(
                    offset: Offset(0, -30),
                    child: Text("INFORMASI KESEHATAN", style: TextStyle(color: Colors.white, fontSize: 16),))
                // Text("Visualisasi")
              ],
            ),
          ),
