            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  child: Column(
                    children: [
                      Text(item.newsTitle,style: TextStyle( fontSize: 22.sp, fontWeight: FontWeight.w500),),
                      SizedBox(height: 10.h,),
                      Row(
                        children: [
                          Icon(Icons.date_range, size: 15.sp,),
                          Text(
                            item.date,style: TextStyle(fontSize: 10.sp),
                          ),
                        ],
                      ),
                      SizedBox(
