...
import 'package:spinemotion_app/pages/articlepage/article_widgets.dart';
  ...
  Widget listArticle() {
    List<ListItem> listTiles = [
      ListItem(
          ...
          'Kebiasaan Buruk Pemicu Kifosis yang Harus Dihindari', 'Kifosis merupakan kondisi kelainan di lengkungan tulang belakang.',
          "20 Juli 2024"),
      ListItem(
            ...
            child: Column(
              children: [
                TabBar(
                  ...
                  isScrollable: true,
                  tabs: [
                    Tab(child: Text("Top", style: TextStyle(fontSize: 14.sp),)),
                    Tab(child: Text("Popular", style: TextStyle(fontSize: 14.sp),)),
                  ],
                ),
              ],
            ),
                  ...
                  itemBuilder: (context, index){
                      return InkWell(
                        onTap: (){
                          ...
                          MaterialPageRoute(builder: (context) => DetailsScreen(item: listTiles[index], tag: listTiles[index].newsTitle, key: null,)));
