                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5.h,),
                          buildTextField("Enter your full name", "email", "user", _fullname ),
                          reusableText("Email"),
                          SizedBox(height: 5.h,),
                          buildTextField("Enter your email adress", "email", "email", _email),
                          reusableText("Phone Number"),
                          SizedBox(height: 5.h,),
                          buildTextField("Enter your phone number", "email", "phone", _noHp),
                          reusableText("Password"),
                          SizedBox(height: 5.h,),
                          buildTextField("Enter your password", "email", "lock", _password),
                          reusableText("Confirm Password"),
                          SizedBox(height: 5.h,),
                          buildTextField("Enter your password", "email", "lock", _confirmPassword),
                          reusableText("Gender"),
                          SizedBox(height: 5.h),
                          Column(
